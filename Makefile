...
deploy-sepolia :; @forge script script/${contract}.s.sol:Deploy${contract} --rpc-url ${RPC_URL}  --private-key ${PK} --broadcast --verify --etherscan-api-key ${FTMSCAN_API_KEY}  -vvvv
...
deploy-all :; make deploy-${network} contract=Refunder
